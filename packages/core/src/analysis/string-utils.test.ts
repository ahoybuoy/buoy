...
import { stringSimilarity, levenshteinDistance, normalizeForComparison } from './string-utils.js';
...
describe('stringSimilarity', () => {
  ...
  it('is symmetric', () => {
    ...
    expect(stringSimilarity('button', 'Button')).toBe(stringSimilarity('Button', 'button'));
  });
});
...
describe('normalizeForComparison', () => {
  ...
  it('handles multiple transformations', () => {
    ...
    expect(normalizeForComparison('BaseSubmit-Button-View')).toBe('submitbutton'); // Base prefix + View suffix + separators stripped
  });
